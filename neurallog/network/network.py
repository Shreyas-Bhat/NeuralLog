...
from neurallog.language.language import Atom, Term, HornClause, Literal, \
...
from neurallog.network.network_functions import get_literal_function, \
...
class NeuralLogNetwork(keras.Model):
    ...
    def _build_literal(self, atom, predicates_depths, inverted=False):
        ...
        :rtype: LiteralLayer or
        neurallog.network.network_functions.FunctionLayer
        """
    ...
    def _build_function_layer(self, renamed_literal):
        ...
        :rtype: neurallog.network.network_functions.FunctionLayer
        """
